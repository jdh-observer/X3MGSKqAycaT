...
<!-- #region tags=["narrative"] -->
The website and data behind _Mapping the Gay Guides_ are tools for scholars looking to study the contours of American gay life in the last four decades of the twentieth century. By digitizing the guides and turning into data MGG offers scholars new paths to analyzing queer life through either the mapping visualization on the MGG website or through applying computational methods to the underlying dataset.
